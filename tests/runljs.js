...
var LVM = require("../src/ljs.lvm").LVM;
var make_G = require("../src/ljs.baselib").make_G;
var luaopen_bytecode51 = require('../src/ljs.bytecode').luaopen_bytecode51;
var luaopen_module51 = require('../src/ljs.module51').luaopen_module51;
